...
#------CALCULA A DIFERENÇA PERCEPTIVA ENTRE AS CORES DE ENTRADA E A MÉDIA RETORNANDO UMA MATRIZ DE RESULTADOS COM A ÚLTIMA COLUNA COM AS DIFERENÇAS ENTRE AS CORES-----------
t=0;
soma=0;
